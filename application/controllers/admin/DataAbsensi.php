...
class DataAbsensi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        INNER JOIN data_jabatan ON data_pegawai.jabatan = data_jabatan.jabatan
    ...
    public function inputAbsensi()
    {
        ...
        $data['input_absensi'] = $this->db->query("SELECT data_pegawai.*, data_jabatan.jabatan FROM data_pegawai
        INNER JOIN data_jabatan ON data_pegawai.jabatan=data_jabatan.jabatan
